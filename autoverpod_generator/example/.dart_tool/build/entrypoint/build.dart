...
import 'package:autoverpod_generator/builder.dart' as _i5;
...
final _builders = <_i1.BuilderApplication>[
  ...
  _i1.apply(
    r'autoverpod_generator:form_provider_generator',
    [_i5.formProviderBuilder],
    _i1.toDependentsOf(r'autoverpod_generator'),
    hideOutput: true,
    appliesBuilders: const [r'source_gen:combining_builder'],
  ),
  _i1.apply(
  ...
  _i1.apply(
    r'autoverpod_generator:autoverpod_generator',
    [_i5.autoverpodGenerator],
    _i1.toDependentsOf(r'autoverpod_generator'),
    hideOutput: false,
    appliesBuilders: const [r'source_gen:combining_builder'],
  ),
